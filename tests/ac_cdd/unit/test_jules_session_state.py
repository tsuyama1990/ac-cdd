...
class TestSessionStateValidation:
    ...
    @pytest.mark.asyncio
    async def test_get_session_state_in_progress(self, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_get_session_state_completed(self, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_get_session_state_on_error(self, mock_client):
