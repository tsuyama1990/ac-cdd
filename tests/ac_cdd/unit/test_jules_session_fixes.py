...
@pytest.mark.asyncio
async def test_monitor_session_batching():
...
@pytest.mark.asyncio
async def test_monitor_session_returns_early_on_change():
...
@pytest.mark.asyncio
async def test_validate_completion_stale_detection():
...
@pytest.mark.asyncio
async def test_validate_completion_stale_but_new_transition():
...
@pytest.mark.asyncio
async def test_monitor_session_avoids_validation_loop():
